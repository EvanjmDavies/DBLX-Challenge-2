...
<div id="sidebar">
  ...
  <div class="wrapper">
    <p class="t1">Welcome to MCG</p>
  </div>
  <div class="wrapper socials">
    <a href="#"><svg id="Bold" enable-background="new 0 0 24 24" height="512" viewBox="0 0 24 24" width="512" xmlns="http://www.w3.org/2000/svg"><path d="m15.997 3.985h2.191v-3.816c-.378-.052-1.678-.169-3.192-.169-3.159 0-5.323 1.987-5.323 5.639v3.361h-3.486v4.266h3.486v10.734h4.274v-10.733h3.345l.531-4.266h-3.877v-2.939c.001-1.233.333-2.077 2.051-2.077z"/></svg></a>
...
<!-- Bottom Nav -->
<ul class="bottom-nav">
  <li class="active nav-links link-1">
    <a href="#about-page">
      <div>
        <p class="t1">About MCG</p>
      </div>
      <div>
        <p class="t2">01</p>
      </div>
  ...
  <li class="link-2 nav-links">
    <a href="#mission-page">
      <div>
        <p class="t1">Our Mission</p>
      </div>
      <div>
        <p class="t2">02</p>
      </div>
  ...
  <li class="link-3 nav-links">
    <a href="#careers-page">
      <div>
        <p class="t1">Explore Careers</p>
      </div>
      <div>
        <p class="t2">03</p>
      </div>
...
<!-- This page flow has been created to demonstrate a little creative flair -->
<!-- page 1 -->
<div class="about-page wrap" id="about-page">

  <!-- Logo -->
  <svg version="1.1" id="site-logo"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
     viewBox="0 0 111.6 21.2" xml:space="preserve">
    <g>
      <g>
  ...
  <!-- Text -->
  <div id="human" class="text-container">
    <div class="wrapper">
      <p class="t3"><span class="t4">01</span> <span class="line"></span><span class="line"></span><span class="t4">02</span>  Welcome</p>
      <h1>Creating Human engagement.</h1>
      ...
      <p class="t1 mcg-link">Discover MCG</p>
    </a>
    </div>
  </div>
...
<!-- page 2 -->
<div class="mission-page wrap" id="mission-page">

  <!-- Text -->
  <div class="text-container dark-text">
    <div class="wrapper">
      <p class="t3"><span class="t4">02</span> <span class="line"></span><span class="line"></span><span class="t4">03</span>  Our Mission</p>
...
<!-- page 3 -->
<div class="careers-page wrap" id="careers-page">

  <!-- Text -->
  <div class="text-container dark-text">
    <div class="wrapper">
      <p class="t3"><span class="t4">02</span> <span class="line"></span><span class="line"></span><span class="t4">03</span>  Explore Careers</p>
      <h1>sed do eiusmod tempor incididunt ut labore et.</h1>
...
// A little jQuery used to active the menu when toggled
...
jQuery(document).ready(function($) {
  ...
  $('#menu-toggle').click(function(){
    ...
    $('#sidebar').toggleClass('dark-mode, mobile');
